...
echo "Get Owner"
cast call 0xCf7Ed3AccA5a467e9e704C703E8D87F634fB0Fc9 "getOwner()" --rpc-url http://127.0.0.1:8545
# Crear Orderbook
...
cast call 0xCf7Ed3AccA5a467e9e704C703E8D87F634fB0Fc9 "getKeysOrderBooks()(bytes32[])" --rpc-url http://127.0.0.1:8545
# Obtener un libro especifico
echo "Get Orderbook by ID"
cast call 0xCf7Ed3AccA5a467e9e704C703E8D87F634fB0Fc9 "getOrderBookById(bytes32)(address,address,bool,uint256,uint256)" "0xc404d413e92e9b151a97e823fece65248a27a8236ad3c9e8f92c46d3ab2d450d" --rpc-url http://127.0.0.1:8545