...
library OrderQueue {
    ...
    struct OrderBookNode {
        ...
        bytes32 orderId; //TODO Define Order Id (Hash keccak256(traderAddress,orderType,price,createdAt)
        bytes32 next;
        bytes32 prev;
    }
    ...
    //Insertar
    function push(Queue storage q, address _traderAddress, bytes32 _orderId) internal{
